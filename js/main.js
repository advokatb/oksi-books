...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        // Function to render the notes slider
        async function renderNotesSlider(books, clippings) {
            ...
            function updateSlider() {
                const offset = -currentIndex * 100; // Percentage-based offset
